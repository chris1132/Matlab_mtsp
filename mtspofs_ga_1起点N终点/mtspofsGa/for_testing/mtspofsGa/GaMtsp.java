...
public class GaMtsp extends MWComponentInstance<GaMtsp>
{
    ...
    {
        this(MtspofsGaMCRFactory.newInstance());
    }
    ...
    {
        this(MtspofsGaMCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    ...
    {
        this(MtspofsGaMCRFactory.newInstance(componentOptions));
    }
    ...
    {
        try {
            MWMCR mcr = MtspofsGaMCRFactory.newInstance();
