...
public class GaMtsp extends MWComponentInstance<GaMtsp>
{
    ...
    {
        this(MtspofsGa2MCRFactory.newInstance());
    }
    ...
    {
        this(MtspofsGa2MCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    ...
    {
        this(MtspofsGa2MCRFactory.newInstance(componentOptions));
    }
    ...
    {
        try {
            MWMCR mcr = MtspofsGa2MCRFactory.newInstance();
